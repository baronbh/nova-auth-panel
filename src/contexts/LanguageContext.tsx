...
const translations = {
  en: {
    ...
    "password.description": "An email address must be connected to your account in order to reset your password. Please contact the hospital if you do not have an email address connected to your account.",
    "password.username": "Username (required)",
    "password.username.error": "Username is required",
    "password.email": "Email Address (required)",
    "password.email.placeholder": "example: email@example.com",
    "password.email.error": "Invalid email address",
    "password.button": "Reset Password",
    "password.return": "Return to Sign in page",
    "password.toast.title": "Reset Request Sent",
    "password.toast.description": "Check your email for instructions to reset your password.",
  },
  es: {
    ...
    "password.title": "Restablecer Contraseña",
    "password.description": "Una dirección de correo electrónico debe estar conectada a su cuenta para restablecer su contraseña. Por favor contacte al hospital si no tiene una dirección de correo electrónico conectada a su cuenta.",
    "password.username": "Usuario (requerido)",
    "password.username.error": "El usuario es requerido",
    "password.email": "Dirección de Correo Electrónico (requerida)",
    "password.email.placeholder": "ejemplo: correo@ejemplo.com",
    "password.email.error": "Dirección de correo electrónico inválida",
    "password.button": "Restablecer Contraseña",
    "password.return": "Regresar a la página de inicio de sesión",
    "password.toast.title": "Solicitud de Restablecimiento Enviada",
    "password.toast.description": "Revise su correo electrónico para obtener instrucciones para restablecer su contraseña.",
  },
};
